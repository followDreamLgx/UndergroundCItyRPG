...
public class ButtonBar : MonoBehaviour {
    ...
    private UIButton systermButton;
    ...
    void Awake()
    {
        ...
        systermButton = FindButton("Systerm");
        ...
        EventDelegate ed6 = new EventDelegate(this, "OnSysterm");
        systermButton.onClick.Add(ed6);
    }
    UIButton FindButton(string btnName)
    {
        return this.transform.Find(btnName).GetComponent<UIButton>();
    }
